...
**Companion files:** `GAME_SPEC.md`, `IMPLEMENTATION_SPEC.md`, `level_data.md`, `VISUAL_DESIGN_SPEC.md`
...
Monthly Pass styling should use the shared typography, spacing, corner-radius, shadow, and base color tokens in `VISUAL_DESIGN_SPEC.md`. Premium gold is an extension accent only and must never replace gameplay-semantic orange/green/red/blue states.
